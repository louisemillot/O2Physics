...
#define JETSUBSTRUCTURE_TABLES_DEF(_jet_type_, _jet_description_, _jet_type_full_, _jet_full_description_, _track_type_data_, _cand_type_data_, _cand_description_data_, _track_type_ewsdata_, _cand_type_ewsdata_, _cand_description_ewsdata_, _track_type_mcd_, _cand_type_mcd_, _cand_description_mcd_, _particle_type_, _hfparticle_type_, _hfparticle_description_) \
  ...
  // JETSPLITTING_TABLE_DEF(_jet_type_full_##MCDetectorLevelEventWiseSubtracted, _jet_description_ "DEWS", _jet_full_description_##mcdetectorleveleventwisesubtracted, _track_type_mcd_, _cand_type_mcd_)                                                                                                                                                                                                            \
  // JETSPLITTING_TABLE_DEF(_jet_type_full_##MCParticleLevelEventWiseSubtracted, _jet_description_ "PEWS", _jet_full_description_##mcparticleleveleventwisesubtracted, _particle_type_, _hfparticle_type_)   
                                                                                                                                                                                                          \
