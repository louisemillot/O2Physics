...
void processJetsMCDMatchedMCPForBoucleWeight( soa::<aod::JetMcCollisions>::iterator const& mcCollision,
...
void processJetsMCDMatchedMCPWeighted(soa::<aod::JetCollisions>::iterator const& collision,
